...
=== Validating a custom Builder or Invoker

See https://github.com/projectriff/builder/blob/master/INVOKER_VALIDATION.md{INVOKER_VALIDATION.md} for several ways of validating a custon Builder or Invoker.